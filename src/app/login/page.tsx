"use client"
import { ArrowLeft, Leaf, Mail, Lock, ArrowRight, EyeOff, EyeIcon, Loader2 } from 'lucide-react'
...
function Login({ previousStep, nextStep }: propType) {
 ...
 const handleSubmit = async (e: FormEvent) => {
    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-gradient-to-b from-green-50/50 via-white to-orange-50/30 relative overflow-hidden'>
          ...
          >
            <span>Sign in to your Snapcart account</span> 
          ...
          >
            ...
            {/* Submit Button (Gray when incomplete, Green when complete) */}
            <motion.button
